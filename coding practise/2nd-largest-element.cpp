...
#include <iostream>
using namespace std;
// simple program but dont chk if 2nd element exist or not
...
int main() {
	int arr[] = {12, 12, 12, 12,12,11};
	int index = secondLargest2(arr, sizeof(arr)/sizeof(arr[0]));
	if (index == -1)
